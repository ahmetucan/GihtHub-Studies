...
class Github:
    ...
    def loadfollowers(self):
        ...
        for i in items:
            self.followers.append(i.find_element_by_css_selector(".linkgray.pl-1").text)
    ...
    def getFollowers(self):
        ...
        while True:
            links = self.browser.find_elements_by_class_name("BtnGroup").find_element_by_tag_name("a")
            if len(links)==1:
